    ...
    <>
      ...
      >
        <g clip-path="url(#clip0_7_40)">
          <path
            d="M41 21C41 9.95431 32.0457 1 21 1C9.95431 1 1 9.95431 1 21C1 32.0457 9.95431 41 21 41C32.0457 41 41 32.0457 41 21Z"
            fill="white"
          />
          <mask
            id="mask0_7_40"
...
const LoginGoogle = ({login}) => {
  ...
  const loginhandle = useGoogleLogin({
    ...
    return (
      <div class="px-10 py-1 rounded-2xl border-1 hover:bg-gray-100 cursor-pointer" onClick={loginhandle}>
        <div class="flex items-center justify-between gap-2">
          <GoogleLogo size="40px" />
          <div class="text-label">Continue with Google</div>
        </div>
      </div>
    );
}
